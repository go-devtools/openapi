...
func TestExternalFrontend(t *testing.T) {
	...
	for _, name := range []string{"types.go", "consumer_test.go", "call_flow_test.go", "call_outcome_test.go", "runtime_conditions_test.go", "compiler_conditions_test.go", "build_inputs_test.go", "build_inputs_boundary_test.go", "runtime_build_test.go", "runtime_inputs_test.go", "request_fields_test.go", "request_encoding_test.go"} {
