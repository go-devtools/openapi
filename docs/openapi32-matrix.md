...
| XML | `spec.XML` | Typed roundtrip; public/official field/container/nodeType/namespace/legacy conflict matrix, including explicit false | XML use-site name inference, wire codec and native UI combinations |
