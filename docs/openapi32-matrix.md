...
| Examples | `spec.Example`, Schema examples | Native fixture, public/official native-object matrix, explicit null/false/zero preservation, paired logical/wire values and offline resources | Full wire-example validation and native UI matrix |
