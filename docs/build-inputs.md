...
This stage does not claim complete runtime/profile compatibility checking, every compiler flag/toolchain combination, arbitrary custom C toolchains and external header graphs, or the full product goal. The complete schema/helper/codec matrices, runtime mismatch diagnostics, CI, and final independent cold-cache acceptance remain tracked in the product status.
