...
function start(query, definitions = true) {
  ...
  bundle.presets = { apis: {} };
  const window = { location: { href: 'http://127.0.0.1:18080/docs/' + query }, OpenAPIDisplayNames: {}, OpenAPINativeExamples: {}, OpenAPINativeCompatibility: {}, OpenAPINativeWire: {}, OpenAPINativeSecurity: {} };
